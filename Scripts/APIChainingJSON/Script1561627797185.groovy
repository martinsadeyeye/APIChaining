...
println('.....First name extracted : ' + value)

//assigning the value from the extraction and storing as userName 
GlobalVariable.userName = value

println('.....new Global Variable is ' + GlobalVariable.userName)
